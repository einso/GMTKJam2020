...
////// Specular:
                ...
                float node_2295 = 0.0;
                float node_8322 = (node_2295 + ( (clamp(i.posWorld.g,_minheight_var,_maxheight_var) - _minheight_var) * (1.0 - node_2295) ) / (_maxheight_var - _minheight_var));
